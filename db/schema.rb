...
ActiveRecord::Schema.define(version: 20170429132858) do

  create_table "account_types", force: :cascade do |t|
    t.string   "name",         limit: 255
    t.string   "description",  limit: 255
    t.integer  "tax_category", limit: 4
  ...
  create_table "category_tickers", force: :cascade do |t|
    t.integer  "category_id", limit: 4
    t.integer  "ticker_id",   limit: 4
